...
/**
 * Created by amgoth.naik on 10/14/2017.
 */

public class EditPost extends BaseActivity implements  ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addTagButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //call tag class
                Intent i = new Intent(EditPost.this, editPostKeys.class);
        ...
        docRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                if (user == null) {
                    ...
                    // Write new post
                    writeNewPost(userId, user.username,mEditor.getHtml().toString(),user.uri,postId);
                    //updateCount();
                }
    ...
    // [START write_fan_out]
    private void writeNewPost(String userId, String username, String body,String url,String postId) {
    ...
    public void showError(){
        ...
        customTitle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(EditPost.this, GoogleSignInActivity.class);
                startActivity(i);
                finish();
            }
        });
