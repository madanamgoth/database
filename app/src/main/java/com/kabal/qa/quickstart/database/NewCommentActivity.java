...
/**
 * Created by amgoth.naik on 9/6/2017.
 */

public class NewCommentActivity extends BaseActivity implements View.OnClickListener,ConnectivityReceiver.ConnectivityReceiverListener {
   ...
   // private EditText mBodyField;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //back start
       // ansCount=getIntent().getStringExtra("ansCount");
       ...
       // mBodyField.setText(Body);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //call tag class
                Intent i = new Intent(NewCommentActivity.this, SelectSubKeys.class);
    ...
    private void postComment() {
        ...
        Intent intent = new Intent(NewCommentActivity.this, CommentMainActivity.class);
    ...
    public void updateAnsCount(){
        ...
        docRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                DocumentReference contact = db.collection("post").document(mPostKey);
                if(post.answerCount>=0){
                contact.update("answerCount", post.answerCount+1);
                contact.update("trendCount", post.trendCount+1)
                        .addOnSuccessListener(new OnSuccessListener < Void > () {
                            @Override
                            public void onSuccess(Void aVoid) {
                               // ansCount= String.valueOf(post.answerCount+1);
                            }
                        });
                }
            }
        });
//return to main screen star
        //return to main screen end
    ...
    public void error(){
        ...
        customTitle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(NewCommentActivity.this, GoogleSignInActivity.class);
                startActivity(i);
                finish();
            }
        });
