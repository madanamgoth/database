...
/**
 * Created by amgoth.naik on 12/11/2017.
 */

public class CreatePollKeys extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list2=getIntent().getStringArrayListExtra("answerTags");
        if(list2==null){
            list2=new ArrayList<String>();
        }
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            /*final String  products[] = {"@India", "@Andaman and Nicobar Islands", "Andhra Pradesh", "Arunachal Pradesh", "Assam", "Bihar", "Chandigarh",
               ...
               /* Toast.makeText(SelectKeys.this, "click-position:" + position + ", text:" + text,
                        ...
                        AlertDialog dialog = new AlertDialog.Builder(CreatePollKeys.this)
                                .setTitle("long click")
...
//                mTagContainerLayout1.addTag(text.getText().toString(), 4);
                ...
                lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if ("newpoll".equals("newpoll")) {
                            ...
                            Intent i = new Intent(CreatePollKeys.this, MainActivity.class);
                ...
                text.addTextChangedListener(new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                        ...
                        CreatePollKeys.this.adapter.getFilter().filter(cs);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_name) {
            ...
            i.putStringArrayListExtra("answerTags", (ArrayList<String>) list2);
